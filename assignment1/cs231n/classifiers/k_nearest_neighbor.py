...
class KNearestNeighbor(object):
    ...
    def compute_distances_no_loops(self, X):
        ...
        dists = np.sqrt(np.reshape(np.power(x, 2).sum(axis=1), (x.shape[0], 1)) - 2 * np.dot(x, y) + np.reshape(
            np.power(y, 2).sum(axis=0), (1, y.shape[1])))
        #########################################################################
        #                         END OF YOUR CODE                              #
        #########################################################################
        return dists
    ...
    def predict_labels(self, dists, k=1):
        ...
        for i in xrange(num_test):
            ...
            closest_y = self.y_train[nearest[:k]]
            #########################################################################
            # TODO:                                                                 #
